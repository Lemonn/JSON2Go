...
type PathData struct {
	...
	// DirectToForceSourceType Set if the ForceSourceType implements it's own unmarshall function and therefore
	// does not need an intermediate step
	DirectToForceSourceType bool `json:"directToForecedType,omitempty"`
}
